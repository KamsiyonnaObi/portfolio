    ...
    <>
      {props.services.data.map((service, idx) => {
        ...
        return (
          <Card
            key={idx}
            className="group service-card w-[287.358px] py-[30px] pl-[25px] pr-[29.36px] rounded-[10px] gap-9 bg-white-800  dark:bg-black-300  dark:shadow-serv-dark "
          >
            ...
            <CardBody className="p-0">
              <div className="flex flex-col gap-2.5">
                <h3 className="base-bold text-black-200 group-hover:text-white-900 dark:text-white-900">
                  {service.title}
                </h3>
